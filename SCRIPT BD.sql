...
insert into debit_card_name (name,brand_card_id,active) values ('Visa Débito Benefit',1,1);
insert into debit_card_name (name,brand_card_id,active) values ('Visa Débito Clásica',1,0);
...
insert into credit_card_name (name,brand_card_id,active) values ('Visa Clásica',1,1);
